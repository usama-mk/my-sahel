...
function LandingHero() {
  ...
  return (
    <div className="flex flex-col sm:flex-row">
      {/* hero Left */}
      <div className="bg-[#009688] sm:w-[50%] w-[100%] flex flex-col p-5 items-center justify-center sm:items-start  ">
      ...
      <div className="bg-[gray] sm:w-[50%] w-[100%] ">
        ...
        <img src={heroGirl} className='opacity-[88%] object-contain' alt="" />
