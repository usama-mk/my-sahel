        ...
        return(
            <div className='flex flex-col sm:flex-row   ' >
                ...
                <div className='sm:w-[50%] bg-[#161616] text-white py-10 px-5 ' >
                    ...
                    <LatestTag tagName={"about"}/> 
                    <LatestTag tagName={"history"}/> 
                     </div>
                     ...
                     <h5 className='font-light text-[12px] my-10 text-left ' >Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </h5>

                    <h5 className='font-light text-[12px] text-left ' >
